...
Notez que si vous ajoutez _<</task_add_collector_svm.html#permissions-when-adding-via-cluster-management-ip,csuser>>_, cet utilisateur requiert un accès SSH au LIF de gestion ONTAP.

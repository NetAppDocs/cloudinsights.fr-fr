...
* Dans les environnements mutualisés, les pannes peuvent se produire en raison de modifications mal configurées. Dans des environnements très dynamiques, Cloud Insights change Analytics peut ne pas être en mesure de suivre correctement tous les changements.

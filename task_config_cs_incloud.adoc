...
Consultez la documentation OnCommand Cloud Volumes ONTAP pour configurer une instance AWS à un seul nœud/haute disponibilité pour héberger l'agent de sécurité workloads :https://[]

Une fois la configuration terminée, suivre les étapes de configuration de votre SVM :https://[]
...
. Sélectionnez une ami RHEL ou CentOS avec la version appropriée, comme indiqué sur cette page :https://[]

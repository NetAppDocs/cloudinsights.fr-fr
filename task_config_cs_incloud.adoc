...
Consultez la documentation OnCommand Cloud Volumes ONTAP pour configurer une instance AWS à un seul nœud/haute disponibilité pour héberger l'agent Cloud Secure :https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/index.html[]

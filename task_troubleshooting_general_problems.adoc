...
| Cloud Insights se déconnecte toutes les 5 minutes | Activez l'acceptation par un tiers des cookies NetApp et auth0 nécessaires.

Exemple :
Dans Chrome, saisissez « chrome://settings/cookies » dans l'URL du navigateur.

Sélectionnez l'option « Autoriser tous les cookies ».
*OU*
Sélectionnez « bloquer les cookies tiers » et ajoutez des exceptions pour [\*.]auth0.com et [*.]netapp.com.

Remarque : veillez à sélectionner l'option « y compris les cookies tiers sur ce site » lors de la création d'une exception. 

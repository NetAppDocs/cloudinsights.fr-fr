...
* Compte utilisateur root/sysadmin et mot de passe existant sur tous les serveurs hébergeant les composants Ops Center. HDS n'a pas pris en charge les API REST pour une utilisation par des utilisateurs LDAP/SSO jusqu'à Ops Center 10.8+

...
| Mes événements kubernetes ont cessé de générer des rapports sur Cloud Insights de manière inattendue. | Récupérer le nom du pod Event-exportateur :
...
....
 - Clé : FICHIER_JOURNAL
   valeurs :
   - /var/log/containers/netapp-ci-event-exportatrice*.log
....

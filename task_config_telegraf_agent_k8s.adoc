...
| Mes événements kubernetes ont cessé de générer des rapports sur Cloud Insights de manière inattendue. | Récupérez le nom du pod Event-exportateur `kubectl -n pods netapp-monitoring 


| grep exportateur-événement | awk '{print $1}' 
|===

...
Remarque : si vous souhaitez supprimer des autorisations ajoutées précédemment, les modifications ne prendront effet qu'au redémarrage du module _event-exportatrice_.

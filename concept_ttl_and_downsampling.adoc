...
Cloud Insights conserve les données pendant une durée déterminée par l'édition souscrite active.
...
| Premium | 13 mois 
|===
Une liste complète des fonctions disponibles dans chaque édition est disponible sur le Cloud Insights link:https://bluexp.netapp.com/cloud-insights-pricing["Éditions et tarification"] page.

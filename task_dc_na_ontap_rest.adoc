...
* Vous devez avoir accès à un compte utilisateur avec le niveau d'accès requis
...
+
** Fonctionnellement, Cloud Insights fait des demandes de lecture, mais certaines autorisations d'écriture sont requises pour que l'EC s'enregistre auprès de la baie ONTAP. Reportez-vous à la remarque sur les autorisations ci-dessous.

...
....
Assurez-vous de consulter la section autorisations du link:/cloudinsights/task_add_collector_svm.html["Configuration du SVM Data Collector de ONTAP"] page également.

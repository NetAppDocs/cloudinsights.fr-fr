...
=== Latence du volume iSCSI

Les indicateurs de latence du volume iSCSI sont disponibles dans les tableaux de bord, les alertes, etc. Pour collecter les mesures de latence iSCSI, activez _performances réseau et Map_ à partir de l'élément de menu « Modifier le déploiement » du collecteur Kubernetes.

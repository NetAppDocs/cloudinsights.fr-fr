...
=== Signalement des données PV Kubernetes

Les informations de volume persistant Kubernetes collectées par Cloud Insights sont désormais disponibles pour le reporting, permettant la refacturation, les tendances, les prévisions, les calculs TTF, Par ailleurs, les autres rapports métier sur les metrics pour les clusters Kubernetes, les espaces de noms, les charges de travail, etc.
...
* https://[] (Remarque : vous devez vous connecter au service de support NetApp)
* https://[]

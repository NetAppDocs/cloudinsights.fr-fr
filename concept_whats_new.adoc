...
Le composant de génération de rapports de Cloud Insights a été nommé « analyse Cloud Insights ». Ne vous inquiétez pas, cependant, la fonctionnalité reste la même.

...
=== Chargement de l'écran de sécurité de la charge de travail amélioré

Cloud Insights a amélioré l'expérience utilisateur en affichant plus efficacement les écrans d'observabilité et de sécurité des workloads, réduisant ainsi le temps de chargement lorsque vous naviguez entre ces fonctionnalités. Notez que les URL de la page sécurité des workloads ont changé. Les URL précédentes seront automatiquement redirigées vers les nouvelles URL.

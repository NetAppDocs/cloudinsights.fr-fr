...
Cloud Insights peut désormais créer des rapports sur toutes les données Kubernetes, y compris les volumes persistants, la demande de volume persistant, la charge de travail, le cluster et le namespace.

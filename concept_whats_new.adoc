...
* Liste blanche *autorisé types de fichiers* : si une attaque par ransomware est détectée pour une extension de fichier connue, cette extension peut être mise en blanc pour empêcher les alertes inutiles. - link:/ws_allowed_file_types.html["En savoir plus >>"]

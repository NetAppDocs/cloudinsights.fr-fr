...
** Protocole SMB version 3.1 et antérieure. Notez que la sécurité des workloads ne fonctionne pas avec les configurations SMB qui utilisent FlexCache. Depuis les versions 9.7, Fpolicy est uniquement prise en charge dans un environnement NFS.

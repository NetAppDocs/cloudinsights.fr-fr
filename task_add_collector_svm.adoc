...
** Protocole NFS version 4.1 et antérieure
...
* Pendant la pause, les paramètres fpolicy de ONTAP sont désactivés, mais ne sont pas supprimés. Lors de la reprise, les paramètres fpolicy de ONTAP sont réactivés.

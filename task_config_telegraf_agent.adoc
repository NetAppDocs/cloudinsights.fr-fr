...
Pour plus d'informations sur l'installation sur Kubernetes, reportez-vous au link:task_config_telegraf_agent_k8s.html["Opérateur de surveillance NetApp Kubernetes"] page.

...
summary: Configuration du collecteur de données REST Dell EMC Isilon. 
---
= Collecteur de données REST Dell EMC Isilon
:allow-uri-read: 


[role="lead"]
Cloud Insights utilise le collecteur de données SSH REST Dell EMC Isilon pour acquérir des données d'inventaire et de performances provenant du stockage Dell EMC Isilon.
...
* Autorisations d'administrateur pour le stockage REST Dell EMC Isilon
* Adresse IP du cluster DE REPOS Dell EMC Isilon

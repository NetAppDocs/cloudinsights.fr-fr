...
. Dans le menu sécurité de la charge de travail, cliquez sur : *Admin > collecteurs de données > collecteurs d'annuaire d'utilisateurs > + collecteur d'annuaire d'utilisateurs* et sélectionnez *Active Directory*
+

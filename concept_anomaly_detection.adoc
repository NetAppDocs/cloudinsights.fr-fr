...
image:Anomaly Detection Monitor Choice.png["Sélection de la détection des anomalies lors de la création d'un moniteur, largeur=480"]
...
image:Anomaly Detection Monitor Conditions.png["Réglage des conditions du moniteur de détection d'anomalie"]

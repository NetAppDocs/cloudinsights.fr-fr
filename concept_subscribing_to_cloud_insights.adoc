...
La sécurité de la charge de travail est mesurée selon que les nœuds utilisés sont haut de gamme, milieu de gamme ou entrée de gamme, selon le nombre d'unités gérées (MU) suivant :

|===


| Type de nœud : | Exemples de modèles : | Mesure effectuée à : 


| 1 nœud haut de gamme | 700, 800, 900, 9xxx | 80 unités gérées 


| 1 nœud milieu de gamme | 300, 400, 500, 8 x 00 | 40 unités gérées 


| 1 nœud d'entrée de gamme | 1xx, 2xx, 2xxx | 20 unités gérées 


| 1 ONTAP logiciel | CVO, FSX | 10 unités gérées 


| 1 nœud inconnu |  | 80 unités gérées 
|===

...
Pour les ccsuser avec des informations d'identification _cluster_, exécutez les commandes suivantes à partir de la ligne de commande ONTAP. Notez que _csrole_ est un rôle personnalisé et _csuser_ est un utilisateur personnalisé ONTAP.

...
NOTE: Étant donné que NetApp BlueXP a son propre délai de connexion utilisateur de 7 jours, Cloud Insights doit également se déconnecter avec cet événement. Il vous suffit de vous connecter à nouveau pour que votre tableau de bord continue à s'afficher.
